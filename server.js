...
app.post('/childLocation', function(request, response) {
    id = request.param('id');
    console.log(id);
    // if(request.param('latitude')!=null){
    //      latitude = request.param('latitude');
    //      longitude = request.param('longitude');
    // }
    sendNotification();
    response.send('Location received of Student ID: "' + request.param('id') + '".');
});
...
app.post('/busLocation', function(request, response) {
    ...
    response.send('Location received of Bus ID: "' + id + '".');
});
    ...
    ref.once("value", function(snapshot) {
        ...
        if (data != null) {
            ...
            var payload = {
                notification: {
                    title: "Child Tracking System",
                    body: "Location of "+data.name+" received"
                },
                data: {
                    latitude: "19.044392",
                    longitude: "72.820493"
